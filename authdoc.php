...
<?php
    ...
    <section class="doctors" id="doctors">
        ...
        <h1 class="heading"> Our <span>Recommendation</span></h1>
...
<section class="footer" id="footer">
    <div class="box-container">
        <div class="box">
            ...
            <a href="index.html#doctors"> <i class="fas fa-chevron-right"></i> Hospitals </a>
            <a href="index.html#book"> <i class="fas fa-chevron-right"></i> book </a>
            <a href="index.html#review"> <i class="fas fa-chevron-right"></i> review </a>
